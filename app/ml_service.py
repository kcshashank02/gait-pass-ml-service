...
#     def __init__(self):
#         self.app = None
#         self.model_name = 'buffalo_sc'  # Changed to lightweight model
...
#             self.app.prepare(ctx_id=-1, det_size=(640, 640))  # Changed to (320, 320)
...
#             embedding = face.embedding.tolist() # Changed to normed_embedding
